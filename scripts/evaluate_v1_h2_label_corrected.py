...
V0_OOF_PATH = Path(
    "data/processed/v0_lc_xgb_a5_oof_predictions.parquet"
)

H1_OOF_PATH = Path(
    "data/processed/v1_h1_lc_oof_predictions.parquet"
)

H2_OOF_PATH = Path(
    "data/processed/v1_h2_lc_oof_predictions.parquet"
)

METRICS_PATH = Path(
    "artifacts/v1_h2_lc_metrics.csv"
)

COMPARISON_PATH = Path(
    "artifacts/v1_h2_lc_vs_h1_lc_v0_lc_comparison.csv"
)
